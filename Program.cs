...
namespace laba4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 10; i < 30; i++)
            {
                string path = @"C:\Users\Денис\Desktop\Uni\ООП\laba4\txt\" + i + ".txt";
                try
                {
                ...
                {
                    using (StreamWriter no_file = new StreamWriter(@"C:\Users\Денис\Desktop\Uni\ООП\laba4\txt\no_file.txt", true, System.Text.Encoding.Default))
                    {
                ...
                {
                    using (StreamWriter bad_data = new StreamWriter(@"C:\Users\Денис\Desktop\Uni\ООП\laba4\txt\bad_data.txt", true, System.Text.Encoding.Default))
                    {
                ...
                {
                    using (StreamWriter overflow = new StreamWriter(@"C:\Users\Денис\Desktop\Uni\ООП\laba4\txt\overflow.txt", true, System.Text.Encoding.Default))
                    {
